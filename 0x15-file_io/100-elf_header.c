...
/**
 * _magic -  magic numbers of an ELF header.
...
/**
 * process_class - class of an ELF header.
 * @e_ident: A pointer containing the ELF classes.
 */
...
/**
 * _os - Prints the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
...
/**
* access_func - utility function
* @header: a point to the elf
* Return: nothing
*/
void access_func(Elf64_Ehdr *header)
{
	check_elf(header->e_ident);
	printf("ELF Header:\n");
	_magic(header->e_ident);
	process_class(header->e_ident);
...
/**
* main - entry point. Display the files info at start
